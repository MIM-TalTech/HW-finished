...
namespace HW4.Pages.Extensions {
    ...
    public static class DisplayControlsForHtmlExtension {
        ...
        public static IHtmlContent DisplayControlsFor<TModel, TResult>(this IHtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TResult>> expression, string value)
        {
